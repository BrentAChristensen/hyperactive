...
class ImpactRqtJointStates(Plugin):
    def __init__(self, context):
        super(ImpactRqtJointStates, self).__init__(context)
        self.setObjectName('ImpactRqtJointStates')
...
class MyWidget(QWidget):
    def __init__(self):
        ...
        print("Joint State Monitor constructor called...")
        ...
        self.label = QLabel('Waiting for joint states...', self)
        ...
        self.node = rclpy.create_node('impact_rqt_joint_states')
